  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', background: 'var(--bg-main)', padding: '2rem' }}>
      <div className="card" style={{ width: '400px', textAlign: 'center', padding: '2.5rem' }}>
            ...
            <div className="form-group" style={{ marginTop: '1rem' }}>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  required
                  placeholder="••••••••"
                  style={{ padding: '0.8rem', paddingRight: '2.5rem' }}
                />
                <button
                  type="button"
        ...
        <div style={{ marginTop: '1.5rem', fontSize: '0.65rem', color: '#94a3b8' }}>v1.0.0025</div>
      </div>
    </div>
  );
};
  ...
  return (
    <aside className="sidebar">
      ...
      <div style={{ marginTop: 'auto' }}>
        <div style={{ fontSize: '0.65rem', color: '#94a3b8', textAlign: 'center', marginBottom: '0.5rem', fontWeight: '500' }}>v1.0.0025</div>
